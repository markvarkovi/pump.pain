    ...
    <>
      <div className="mx-24 mt-12 2xl:mx-64 mt-12 text-gray-50 tracking-wider text-lg flex flex-col items-center bg-red-400 rounded-xl border border-yellow-800 border-double p-12 bg-opacity-10">
        ...
        <p className="text-2xl mx-26">
          At HamLana, we provide a space for investors to express their anger,
          ...
          you want to join the fight against rug-pullers, Hamlana are here for you. Just
          roll a joint and join the Hamlanas!
          <br />
          <br />
